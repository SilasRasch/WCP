...
{
    public interface IOrganizationService : IDatabaseService<Organization>, IDtoExtensions<OrganizationDto, Organization>, IObjectViewService<Organization, OrganizationView>
    {
